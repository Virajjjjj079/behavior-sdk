...
@Entity
@Table(name = "mousekeyboardbase")
public class MouseKeyboardBase {
    ...
    public void setTimestamp(LocalDateTime timestamp) {
     ...
     public MouseKeyboardBase() {}

    public MouseKeyboardBase(Long userID, String userName, Double typingSpeed, Double avgKeyHoldTime,
