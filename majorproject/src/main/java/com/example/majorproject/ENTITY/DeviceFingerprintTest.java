...
@Entity
@Table(name = "devicefingerprinttest")
public class DeviceFingerprintTest {
    ...
    public DeviceFingerprintTest() {}

    public DeviceFingerprintTest(Long userID, String userName, String deviceData, String fingerprint, LocalDateTime timestamp) {
        this.userID = userID;
